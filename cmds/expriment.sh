...
# CUDA_VISIBLE_DEVICES=0 accelerate launch --num_processes 1 --main_process_port 29051 eval/eval_mt_bench.py --eval_mode large --target_model llama-68m --draft_model llama-68m --gamma 5 -n 1 -e llama --max_tokens 128 --temp 0

# CUDA_VISIBLE_DEVICES=0 accelerate launch --num_processes 1 --main_process_port 29051 eval/eval_mt_bench.py --eval_mode large --target_model tiny-vicuna-1b --draft_model llama-68m --gamma 5 -n 1 -e llama --max_tokens 128 --temp 0

# CUDA_VISIBLE_DEVICES=0 accelerate launch --num_processes 1 --main_process_port 29051 eval/eval_mt_bench.py --eval_mode large --target_model llama-2-13b --draft_model llama-68m --gamma 5 -n 1 -e llama --max_tokens 128 --temp 0
